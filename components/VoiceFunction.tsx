import AudioRecorderPlayer, {
  ...
  import {Dimensions,PermissionsAndroid,Platform,SafeAreaView,StyleSheet,Text,TouchableOpacity,View,Button
  } from 'react-native';
  ...
  const  Voice: FC<VoiceProps> =()=>{
    ...
    // state: { isLoggingIn: boolean; recordSecs: number; recordTime: string; currentPositionSec: number; currentDurationSec: number; playTime: string; duration: string; };
